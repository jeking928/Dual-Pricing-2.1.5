...
//*************************************************************** 
?>
                <td colspan="2" class="dataTableContent" align="right"><?php echo zen_get_products_display_price($products->fields['products_id']); ?>&nbsp;/&nbsp;
<?php
if ($products->fields['products_price_w']!='0'){ ?>
<b><?php echo $products->fields['products_price_w']; ?></b>
<?php 
} else { 
echo $products->fields['products_price_w'];}
//***************************************************************
//***** END DISPLAY WHOLESALE PRICE
//*************************************************************** 
?>
</td>
// Dual Pricing start              
